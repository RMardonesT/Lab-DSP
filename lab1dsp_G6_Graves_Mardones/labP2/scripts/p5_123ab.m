...
title({'Autocorrelación del error de cuantización ','y correlación de error con la señal original usando 2 bits - musica\_16\_16.wav'})

[y,e] = cuantiza2(data1,N_12);
[re,le] = xcorr(e,200, 'unbiased');
[r,l] = xcorr(e,data1,200, 'unbiased');
legend("Autocorrelación del error","Correlación del error con la señal original")
...
plot(le,re)
ylabel("Amplitud");xlabel("Muestras")
title({'Autocorrelación del error de cuantización ','y correlación de error con la señal original usando 12 bits - musica\_16\_16.wav'})
legend("Autocorrelación del error","Correlación del error con la señal original")
