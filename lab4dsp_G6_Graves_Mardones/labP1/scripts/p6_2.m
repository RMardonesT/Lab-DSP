...
title({'Magnitud de DFT de x(n) = \delta(n)', 'usando FFT8, FFT4 y FFT2'},"FontSize",tsize)
subplot 232 
stem(0:7,abs(Sb));xlim([0 7])
xlabel("Bins de frecuencia [-]","FontSize",size1);
xlabel("Bins de frecuencia [-]","FontSize",size1);
ylabel("Magnitud [-]","FontSize",size1)
title({'Magnitud de DFT de x(n) = 1','usando FFT8, FFT4 y FFT2'},"FontSize",tsize)
subplot 233 
stem(0:7,abs(Sc));xlim([0 7])
xlabel("Bins de frecuencia [-]","FontSize",size1);
ylabel("Magnitud [-]","FontSize",size1)
title({'Magnitud de DFT de x(n) = exp(-j2\pi n/8)','usando FFT8, FFT4 y FFT2'},"FontSize",tsize)
