 ...
 *
 *         double y1 = retardo_circular(double u1)
 *
 *    Simulink version           : 10.1 (R2020a) 18-Nov-2019
 *    C source code generated on : 10-May-2021 17:59:21
 *
...
#define S_FUNCTION_NAME  retardo_circular
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "retardo_circular", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
