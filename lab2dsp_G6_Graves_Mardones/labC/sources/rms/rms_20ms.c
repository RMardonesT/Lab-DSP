 ...
 *
 *         double y1 = rms_20ms(double u1)
 *
 *    Simulink version           : 10.1 (R2020a) 18-Nov-2019
 *    C source code generated on : 13-May-2021 20:31:31
 *
...
#define S_FUNCTION_NAME  rms_20ms
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "rms_20ms", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
