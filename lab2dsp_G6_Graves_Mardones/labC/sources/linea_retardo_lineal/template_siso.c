 ...
 *
 *         double y1 = retardo_lineal(double u1, double u2)
 *
 *    Simulink version           : 10.3 (R2021a) 14-Nov-2020
 *    C source code generated on : 04-May-2021 13:44:12
 *
...
/**
     ...
     def.OutputFcnSpec = 'double y1 = retardo_lineal(double u1, double u2)';
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "retardo_lineal", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
