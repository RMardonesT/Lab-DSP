/**
 * retardo_lineal_int.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         int16 y1 = retardo_lineal_int(int16 u1)
 *
 *    Simulink version           : 10.1 (R2020a) 18-Nov-2019
 *    C source code generated on : 13-May-2021 17:53:01
 *
...
#define S_FUNCTION_NAME  retardo_lineal_int
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "retardo_lineal_int", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
